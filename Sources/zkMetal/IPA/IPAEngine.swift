...
public class IPAEngine {
    ...
    /// Precompute BGMW lookup tables for all generators using C implementation.
    ...
    public func commitBGMW(_ a: [Fr]) -> PointProjective {
        ...
        // Call C BGMW MSM: multi-threaded table lookup + mixed additions
