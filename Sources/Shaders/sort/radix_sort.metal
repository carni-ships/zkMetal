...
//   3. scatter: SIMD-level parallel ranking + global scatter
//
// TILE_SIZE=4096 balances threadgroup count against per-tile work.
...
// --- Kernel 3: Stable scatter with SIMD ranking ---
