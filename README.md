...
**107 primitives** across 18 fields and 10 elliptic curves:
...
Run `swift build && .build/debug/zkMetalTests`. 129 test files, 131 test suites. All GPU kernels verified against CPU reference implementations.
