...
\midrule
$2^{16}$ & \textbf{0.85\,ms} & 89\,ms & \textbf{0.26\,ms} & 86\,ms \\
$2^{18}$ & \textbf{1.72\,ms}  & 108\,ms & \textbf{0.54\,ms} & 92\,ms \\
$2^{20}$ & \textbf{6.06\,ms}  & 194\,ms & \textbf{0.79\,ms} & 108\,ms \\
$2^{22}$ & \textbf{26.0\,ms}   & 915\,ms & \textbf{3.0\,ms}  & 181\,ms \\
$2^{24}$ & \textbf{110.9\,ms}  & 3892\,ms & \textbf{2.3\,ms} & 709\,ms \\
\bottomrule
\end{tabular}
\end{table}
...
BLS12-377 (119\,ms) pays a 2.6$\times$ penalty from wider limbs (12$\times$32-bit vs.\ 8$\times$32-bit for BN254).
secp256k1 (200\,ms) cannot use GLV due to the scheduling pathology (\S\ref{sec:pathology}) and relies on signed-digit only.
...
secp256k1 & 8$\times$32 & 72\,ms & 200\,ms \\
BLS12-377 & 12$\times$32 & 55\,ms & 119\,ms \\
\bottomrule
\end{tabular}
\end{table}
...
BabyBear NTT at $2^{24}$ (1.3$\times$) is essentially memory-bandwidth-limited: 16.8\,M elements $\times$ 4~bytes at 150~GB/s yields a 1.7\,ms floor against the measured 2.3\,ms.
...
BabyBear NTT $2^{24}$ & 2.3\,ms & 1.7\,ms & 1.3$\times$ & Bandwidth \\
...
secp256k1 MSM $2^{18}$ & 200\,ms & 30\,ms & 7$\times$ & No GLV \\
Poseidon2 $2^{16}$ & 8.1\,ms & 1.8\,ms & 4.5$\times$ & Sequential rounds \\
BLS12-377 MSM $2^{18}$ & 119\,ms & 60\,ms & 2$\times$ & 12-limb Fq \\
\midrule
